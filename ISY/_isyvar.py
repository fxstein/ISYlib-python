...
from ISY.IsyExceptionClass import IsyInternalError, IsyValueError, IsyResponseError, IsyPropertyError, \
    IsyLookupError, IsyRuntimeWarning
    ...
    for t in ['1', '2']:
        ...
        for v in vinfo.iter("e"):
            ...
            if n in self.name2var:
                warn("Duplicate Var name (0) : (1) (2)".format(n, vid, self.name2var[n]), IsyRuntimeWarning)
            else:
                self.name2var[n] = vid
