...
#			self._mydict["address"], newwname)
    ...
    def bit_length(self):
        return int(self._mydict["val"]).bit_length()
    ...
    # Type conversion
    def __long__(self):
        return long(self._mydict["val"])

    # Type conversion
    def __float__(self):
        return float(self._mydict["val"])
    ...
    # Type conversion
    def __bool__(self):
        return bool(self._mydict["val"]) != 0

    # mathematical operator
    def __abs__(self):
        return abs(self._mydict["val"])

    #  comparison functions
    def __lt__(self, n):
        return self._mydict["val"] < self.__cast(n)
    ...
    #  comparison functions
    def __cmp__(self, n):
        return cmp(self._mydict["val"], self.__cast(n))
    ...
    def __iadd__(self, n):
        if isinstance(n, self.__class__):
            self._mydict["val"] += n._mydict["val"]
        else:
